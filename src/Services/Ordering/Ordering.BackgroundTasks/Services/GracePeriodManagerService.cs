...
namespace Ordering.BackgroundTasks.Services
{
    public class GracePeriodManagerService : BackgroundService
    {
        ...
        public GracePeriodManagerService(IOptions<BackgroundTaskSettings> settings, IBus bus, ILogger<GracePeriodManagerService> logger)
        {
        ...
        private void CheckConfirmedGracePeriodOrders()
        {
            ...
            foreach (var orderId in orderIds)
            {
                ...
                _bus.Publish(confirmGracePeriodEvent);
            }
        }
